...
let item_config_data = {
    ...
    100:{quality:2,achievement_id:24},
    ...
    155:{quality:2},
    156:{quality:2},
    157:{quality:2,achievement_id:54},
    158:{quality:3},
    159:{quality:3},
    160:{quality:2},
    161:{quality:1},
    ...
    173:{quality:3},
    174:{quality:1},
    175:{quality:2,achievement_id:58},
    176:{quality:1},
    177:{quality:0},
    178:{quality:3},
    ...
    196:{quality:3},
    197:{quality:2},
    198:{quality:1}, // craftquality=1, even though quality=0
    199:{quality:3},
    200:{quality:1},
    201:{quality:2},
    202:{quality:2},
    ...
    222:{quality:2},
    223:{quality:4}, //craftquality=4 even though quality=3
    224:{quality:3},
    225:{quality:2},
    226:{quality:2},
    227:{quality:1},
    ...
    250:{quality:1},
    251:{quality:2},
    252:{quality:0,achievement_id:146},
    253:{quality:2},
    254:{quality:2},
    255:{quality:3},
    256:{quality:1},
    257:{quality:2},
    258:{quality:0,achievement_id:105},
    259:{quality:3},
    ...
    284:{quality:2,achievement_id:148},
    285:{quality:1},
    286:{quality:2,achievement_id:121},
    287:{quality:1,achievement_id:122},
    288:{quality:1},
    ...
    308:{quality:2},
    309:{quality:2},
    310:{quality:3,achievement_id:112},
    ...
    317:{quality:3},
    318:{quality:1},
    319:{quality:2,achievement_id:110},
    320:{quality:2,achievement_id:114},
    321:{quality:1,achievement_id:115},
    322:{quality:2},
    323:{quality:1,achievement_id:106},
    ...
    341:{quality:3},
    342:{quality:3},
    343:{quality:2}, // craftquality=2 even though quality=1
    344:{quality:1},
    345:{quality:3},
    346:{quality:1},
    347:{quality:3},
    ...
    358:{quality:1}, //craftquality=1 even though quality=0
    359:{quality:3},
    ...
    390:{quality:3},
    391:{quality:1,achievement_id:182},
    ...
    397:{quality:3},
    398:{quality:1},
    399:{quality:3,achievement_id:186},
    400:{quality:2},
    401:{quality:3},
    402:{quality:3},
    403:{quality:1},
    ...
    408:{quality:3,achievement_id:184},
    ...
    431:{quality:2},
    432:{quality:2},
    433:{quality:2,achievement_id:195},
    434:{quality:1},
    435:{quality:1},
    436:{quality:1},
    437:{quality:1},
    ...
    454:{quality:2},
    455:{quality:2,achievement_id:307}, //craftquality=2 even though quality=1
    456:{quality:1},
    457:{quality:2},
    458:{quality:3},
    459:{quality:3},
    ...
    483:{quality:3},
    484:{quality:1},
    485:{quality:2,achievement_id:294},
    ...
    514:{quality:3,achievement_id:354},
    ...
    529:{quality:1,achievement_id:374},
    530:{quality:2,achievement_id:376},
    531:{quality:4,achievement_id:377},
    532:{quality:2,achievement_id:378},
    533:{quality:3,achievement_id:380},
    ...
    574:{quality:2},
    575:{quality:3},
    576:{quality:1,achievement_id:517},
    ...
    603:{quality:1}, // craftquality=1 even though quality=0
    604:{quality:1},
    605:{quality:1},
    606:{quality:3},
    607:{quality:1},
    ...
    622:{quality:3,achievement_id:436},
    623:{quality:1},
    624:{quality:1},
    ...
    637:{quality:3},
    638:{quality:2},
    639:{quality:1,achievement_id:442},
    ...
    646:{quality:2,achievement_id:546},
    647:{quality:2},
    649:{quality:1,achievement_id:409},
    650:{quality:1,achievement_id:410},
    651:{quality:3,achievement_id:425},
    652:{quality:1},
    653:{quality:2,achievement_id:424},
    654:{quality:2},
    655:{quality:1},
    ...
    671:{quality:1,achievement_id:443},
    ...
    695:{quality:2,achievement_id:452},
    696:{quality:3,achievement_id:499},
    697:{quality:2,achievement_id:435},
    698:{quality:4,achievement_id:502},
    699:{quality:2,achievement_id:498},
    700:{quality:3,achievement_id:504},
    701:{quality:3,achievement_id:505},
    702:{quality:1,achievement_id:506},
    703:{quality:2,achievement_id:507},
    704:{quality:2,achievement_id:590},
    705:{quality:2,achievement_id:587},
    706:{quality:4,achievement_id:597},
    707:{quality:1},
    708:{quality:3},
    709:{quality:2,achievement_id:437},
    710:{quality:-1,achievement_id:586}, //craftquality-1 even though quality=3 (bag of crafting: uncraftable)
    ...
    720:{quality:3,achievement_id:459},
    721:{quality:0,achievement_id:500},
    722:{quality:3,achievement_id:600},
    723:{quality:4,achievement_id:584},
    724:{quality:2,achievement_id:585},
    725:{quality:0,achievement_id:588},
            ...
            for(let weight_select_i = 0;weight_select_i < weight_list.length;weight_select_i++){
                ...
                for(let item_pool_i = 0;item_pool_i < item_pools.length;item_pool_i++){
                    ...
                    if(item_quality >= quality_min && item_quality <= quality_max){
                        ...
                        maybe_seen[item_pools[item_pool_i].id] = true
                    }
                }
            }
            //label 92
...
document.getElementById('execute').addEventListener('click',function(){
    ...
    seed = str2seed(seed)
    if(seed == 0){
        document.getElementById('tip').innerText = "种子不合法"
        items = undefined
        return
    }
    items = []
    ...
    let output = ""
    search_dfs([29,25,23,8,7,6,5,4,3,2,1],[],(arr)=>{
        let result = get_result(arr, seed)
        items[result] = arr.toString()    
    },8)
    let c = 0
    let all_maybe_seen = 0
    for(let i=0;i<1000;i++){
        if(maybe_seen[i] != undefined){
            all_maybe_seen++
    ...
    output += (c + '/' + all_maybe_seen + " 已找到\n")
    
    let craftable_items = []
    
    let item_pool_ids = [0,1,2,4,3,5,8,12,9,7,26]
    for(let ii = 0;ii<item_pool_ids.length;ii++){
        let item_pool = GetItemPoolData(item_pool_ids[ii])
        for(let ipi=0;ipi<item_pool.length;ipi++){
            let id = item_pool[ipi].id
            craftable_items[id] = true
        }
    }
    let craftable_item_count = 0
    for(let i=0;i<1000;i++){
        if(craftable_items[i]){
            craftable_item_count++
        }
    }
    output+= (craftable_item_count + "可合成道具（道具池理论值）\n")
    output += "当前种子："+document.getElementById('seed_input').value + "\n"
    output += "输入道具编号来查询组合"
